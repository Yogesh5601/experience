...
const ContactUs = () => {
  ...
  return (
    <div id="contact" className="w-full flex flex-col lg:flex-row max-w-screen-xl mx-auto gap-12 lg:gap-6 px-3 p-20 lg:py-28 lg:px-6">
      <div className="w-full order-2 lg:order-1 lg:w-6/12 flex flex-col px-4 py-[30px] lg:p-[50px] gap-6 bg-[#0f0715] rounded-[10px] text-base">
        <div className="w-full flex flex-col gap-4">
          ...
          <p className="text-gray">
            ...
            nam, excepturi eos soluta explicabo expedita recusandae provident
            quas
          </p>
        </div>
        <div className="">
