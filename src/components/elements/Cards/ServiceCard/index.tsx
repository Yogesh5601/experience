...
const ServiceCard = ({
  ...
  return (
    ...
    <div
      ...
      className={`flex items-center justify-between text-gray p-3 lg:px-[30px] cursor-pointer transition-all duration-500 ease-in-out transform border-b border-accent_dark gap-4 ${
        isActive
    ...
    >
      <div className="w-full flex lg:flex-row flex-col items-center justify-between gap-1">
        <div className="w-full lg:w-4/12 flex item-center gap-2 lg:gap-5 lg:py-[30px]">
          ...
          <h3
            className={`flex items-center text-3xl lg:text-4xl font-bold transition-colors duration-500 ${
